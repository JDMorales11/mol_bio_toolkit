...
CODON_FREQUENCIES = {
    "e_coli_k12": {
        "TTT": 19.7, "TTC": 15.0,
        "TTA": 15.2, "TTG": 11.9, "CTT": 11.9, "CTC": 10.5, "CTA": 5.3, "CTG": 46.9,
        "ATT": 30.5, "ATC": 18.2, "ATA": 3.7,
        "ATG": 24.8,
        "GTT": 16.8, "GTC": 11.7, "GTA": 11.5, "GTG": 26.4,
        "TCT": 5.7, "TCC": 5.5, "TCA": 7.8, "TCG": 8.0, "AGT": 7.2, "AGC": 16.6,
        ...
        "TGT": 5.9, "TGC": 8.0,
        "TGG": 10.7,
        "CGT": 21.1, "CGC": 26.0, "CGA": 4.3, "CGG": 4.1, "AGA": 1.4, "AGG": 1.6,
        "GGT": 21.3, "GGC": 33.4, "GGA": 9.2, "GGG": 8.6,
        "TAA": 1.8, "TGA": 1.0, "TAG": 0.0,
    },
    "s_cerevisiae": {
        "TTT": 26.1, "TTC": 18.4,
